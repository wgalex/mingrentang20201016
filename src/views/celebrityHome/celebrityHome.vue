<template>
    <div>
        ...
        <div class="title clearfix" style="padding:80px 0 0 10px">
            ...
            <span class="more" @click="more">更多<i class="cubeic-arrow"></i></span>
        </div>
        <div class="itemsbox">
        ...
        <!-- 单位模块 -->
        <div class="title clearfix" style="padding:10px 0 0 10px">
            <span class="border"></span>
            <span style="font-weight:900">单位荣誉</span>
            <!-- v-if="danweiList.length>4" -->
            <span class="more" @click="mores">更多<i class="cubeic-arrow"></i></span>
        </div>
...
import { queryCategory,queryCarousel,queryCategoryDan } from './api'
export default {
  data () {
    return {
        value: '',
  ...
  mounted(){
    ...
    // localStorage.setItem('orgCode',1021)
    if(localStorage.getItem('orgCode') == '' || localStorage.getItem('orgCode') == undefined || localStorage.getItem('orgCode') == null){
        this.getUser()
    }else{
        //获取单位荣誉
        this.getCategoryDan()
